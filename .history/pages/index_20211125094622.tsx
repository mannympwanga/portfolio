export const index = () => {
  return (
    <div className='flex flex-col px-6 pt-1'>
      ...
      {/*homepage- About me a parargaph about me*/}
      <h1 className='my-3 text-3xl font-Lobster'>About Me</h1>
      <p className='my-3 font-medium'>
        ...
        I am a keen learner and thrive when faced with new challenges that enable me 
        to apply myself in a versatile way. 
        ...
        and traits that are attractive to future hiring managets.
        I am someone who understands you have to work hard to achieve what you want in life,
      ...
      <div>
        ...
        {/*homepage- reason on way I want to be part of SovTech*/}
        <h1 className='my-3 text-3xl font-Lobster'>Why Do I Want To Be A Developer At SovTech</h1>
        <p className='my-3 font-medium'>
          ...
          working here will allow me to deverlop those skills and values, for sure. I strongly believe that I will be an asset 
          to your organization long-term as well as learn a great deal from being a part of your dynamic team. 
          I am also looking forward to meeting new people, making new friends and learning about the culture of SovTech
        </p>
      </div>
    </div>
