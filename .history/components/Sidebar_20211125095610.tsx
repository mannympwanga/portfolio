...
const Sidebar = () => {
    ...
    return (
        ...
        <div>
            ...
            <button className='w-8/12 py-3 pt-3 my-2 text-black rounded-full bg-gradient-to-r from-blue-800 to-red-500 dark:from-dark-200 dark:to-dark-100 dark:text-white'
